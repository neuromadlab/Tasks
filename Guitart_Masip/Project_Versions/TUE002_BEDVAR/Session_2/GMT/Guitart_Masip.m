...
for i_tr = 1:trial_num
    ...
    switch condition_num
        ...
        case 1 % Go to win
            ...
            if (output.circle_correct(i_tr,1) == 1 && output.key_pressed(i_tr,1).keys(end) == 1) || (output.circle_correct(i_tr,1) == 2 && output.key_pressed(i_tr,1).keys(end) == 2)
...
payout = sum(2 - output.feedback_cond * 1) * 0.20