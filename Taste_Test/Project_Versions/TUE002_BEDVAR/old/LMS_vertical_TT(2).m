...
if lang_de
    if strcmp(Question{i_rating,1},'Umami')
        anchor_1 = 'am allerstärksten vorstellbares Umami';
    else
        anchor_1 = ['am allerstärksten vorstellbare ' Question{i_rating,1}];
    end
    anchor_2 = 'sehr stark vorstellbar';
    anchor_3 = 'stark vorstellbar';
    anchor_4 = 'einigermaßen/gering vorstellbar';
    anchor_5 = 'wenig vorstellbar';
    anchor_6 = 'am wenigsten vorstellbar';
    anchor_7 = 'nicht vorstellbar';
else
...
%text_freerating = [trial.question]; %free ratings
...
Screen('TextFont',rating_scr,'Arial');
DrawFormattedText(rating_scr, anchor_1, (ww/2+20), (Scale_offset + 5) + Scale_height * y_6, color_scale_anchors,80);
...
%DrawFormattedText(rating_scr, anchor_7, (ww/2+20), (Scale_offset + 5) + Scale_height * y_0, color_scale_anchors,80);
