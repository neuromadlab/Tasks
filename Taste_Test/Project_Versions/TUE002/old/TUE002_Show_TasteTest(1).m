    ...
    for i_snack = 1 : nrS
        ...
        for i = 1 : n
            ...
            for i_rating = 1 : nrQ
                ...
                % write data to file
                filename = sprintf('TT_%s_%06d_S%01d_R%s_temp_', subj.studyID, subj.id, subj.sess, subj.run);
...
% save result file
filename = sprintf('TT_%s_%06d_S%01d_R%s', subj.studyID, subj.id, subj.sess, subj.run);
