...
function initializingRoutineBegin(snapshot) {
  return async function () {
    ...
    initializingComponents.forEach( function(thisComponent) {
...
function choosingTheLanguageLoopBegin(choosingTheLanguageLoopScheduler, snapshot) {
  return async function() {
    ...
    choosingTheLanguage.forEach(function() {
...
function sendingMessageLoopBegin(sendingMessageLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    sendingMessage.forEach(function() {
...
function chooseLanguageRoutineBegin(snapshot) {
  return async function () {
    ...
    chooseLanguageComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function languageClickedButtonRoutineBegin(snapshot) {
  return async function () {
    ...
    languageClickedButtonComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function textAssignmentRoutineBegin(snapshot) {
  return async function () {
    ...
    textAssignmentComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function timingIssueRoutineBegin(snapshot) {
  return async function () {
    ...
    timingIssueComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function generalLoaderLoopRoutineBegin(snapshot) {
  return async function () {
    ...
    generalLoaderLoopComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function generalLoaderRoutineBegin(snapshot) {
  return async function () {
    ...
    generalLoaderComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function syringeLoaderLoopRoutineBegin(snapshot) {
  return async function () {
    ...
    syringeLoaderLoopComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function syringeLoaderRoutineBegin(snapshot) {
  return async function () {
    ...
    syringeLoaderComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Rules1RoutineBegin(snapshot) {
  return async function () {
    ...
    Rules1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Rules2RoutineBegin(snapshot) {
  return async function () {
    ...
    Rules2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Rules3RoutineBegin(snapshot) {
  return async function () {
    ...
    Rules3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Rules4RoutineBegin(snapshot) {
  return async function () {
    ...
    Rules4Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Rules5RoutineBegin(snapshot) {
  return async function () {
    ...
    Rules5Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Rules6RoutineBegin(snapshot) {
  return async function () {
    ...
    Rules6Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Rules7RoutineBegin(snapshot) {
  return async function () {
    ...
    Rules7Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Rules8RoutineBegin(snapshot) {
  return async function () {
    ...
    Rules8Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Rules9RoutineBegin(snapshot) {
  return async function () {
    ...
    Rules9Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Rules10RoutineBegin(snapshot) {
  return async function () {
    ...
    Rules10Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function IntroductionButtonPressedRoutineBegin(snapshot) {
  return async function () {
    ...
    IntroductionButtonPressedComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function beginningScreenRoutineBegin(snapshot) {
  return async function () {
    ...
    beginningScreenComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function SetupTheSceneRoutineBegin(snapshot) {
  return async function () {
    ...
    SetupTheSceneComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trialOutputRoutineBegin(snapshot) {
  return async function () {
    ...
    trialOutputComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function buttonPressedTrialRoutineBegin(snapshot) {
  return async function () {
    ...
    buttonPressedTrialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function endingScreenRoutineBegin(snapshot) {
  return async function () {
    ...
    endingScreenComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function deleteTheSceneRoutineBegin(snapshot) {
  return async function () {
    ...
    deleteTheSceneComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function savingDataRoutineBegin(snapshot) {
  return async function () {
    ...
    savingDataComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
