...
% Project Version for TUE007 (Corinna Schulz, July 2021:
% New: no Jitter, Incl. Questions about caloric load instead of pain  
%==========================================================================
...
subj.sessionID = input('Session ID [1 2 3 4]: ','s');
subj.tID = input('timepoint [1 2 3 4 5]: ','s');
...
%Instruction text I
text_caloric_load = ['Willkommen. \n\nZunaechst werden wir Ihnen zwei kurze Fragen zum Getränk stellen, das Sie gleich sehen werden.\n\n Anschließend werden wir Ihnen einige Fragen zu Ihrem aktuellen Befinden stellen.'];
Screen('TextSize',w,32);
Screen('TextFont',w,'Arial');
[pos.text.x,pos.text.y,pos.text.bbox] = DrawFormattedText(w, text_caloric_load, 'center', (setup.ScrHeight/5), color.black, 60, [], [], 1.2);
