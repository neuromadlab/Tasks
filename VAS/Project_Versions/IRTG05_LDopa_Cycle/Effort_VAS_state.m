...
elseif strcmp(subj.lang,'0')
    text1 = ['Welcome. \n\n Below you will answer a few questions about how you are currently feeling.'];
end
...
state_questions = {  'hungry', 'hungrig', 'State';
                     ...
                     'salfsatisfaction', 'selbstzufrieden', 'Influenca_1';
