...
subj.sessionID = input('Session: [[1 (phen) | 2 (admin day1) | 3 (admin day 2)]] ','s'); 
subj.tID = input(['timepoint [1 (before REE T1) | 2 (after REE T1/ before injection) | ' ...
    '3 (after FCR/ before EAT) | 4 (after EAT/ before REE T2) | 5 (after REE T2)]: '],'s');
