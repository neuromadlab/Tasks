...
subj.lang = input('Language [1 for German, 2 for English]: ','s');
...
elseif strcmp(subj.lang,'2')
    text = ['Welcome. \n\nWe would like to ask you a few questions about how you are currently feeling.'];
end
...
elseif strcmp(subj.lang,'2')
    text = ['To answer the questions, you will need to move a point on a scale. Move the point with the left joystick on the controller and confirm your answer by pressing the A button (green button, press with the thumb).\nAfter confirming your answer to each question, please let go of the joystick so that it goes back to the middle position.'];
end
Screen('TextSize',w,32);
Screen('TextFont',w,'Arial');
[pos.text.x,pos.text.y,pos.text.bbox] = DrawFormattedText(w, text, 'center', (setup.ScrHeight/5), color.black, 50, [], [], 1.2);
...
for i_state = 1:length(state_questions) 
    ...
    elseif strcmp(subj.lang,'2') % English
