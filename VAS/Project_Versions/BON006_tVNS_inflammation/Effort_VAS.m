...
if settings.lang_de == 1
    ...
    elseif strcmp(trial.type,'load_shake') || strcmp(trial.type,'load_muesli')
        scale.anchor_1 =['Trifft gar nicht zu'];
        scale.anchor_7 =['Trifft voellig zu'];

    elseif strcmp(trial.type,'willingnesspay')
        scale.anchor_1 =['0 Euro'];
        scale.anchor_7 =['2 Euro'];

    elseif strcmp(trial.type,'activity_pay_alone') || strcmp(trial.type,'activity_pay_together')
        scale.anchor_0 = '0 Euro';
        scale.anchor_1 = '10 Euro';
        scale.anchor_2 = '20 Euro';
        scale.anchor_3 = '30 Euro';
        scale.anchor_4 = '40 Euro';
        scale.anchor_5 = '50 Euro';
        scale.anchor_6 = '60 Euro';
        scale.anchor_7 = '70 Euro';
        scale.anchor_8 = '80 Euro';
        scale.anchor_9 = '90 Euro';
        scale.anchor_10 = '100 Euro';
    ...
    if strcmp(trial.type,'pain') % english translation
    ...
    elseif strcmp(trial.type,'activity_pay_alone') || strcmp(trial.type,'activity_pay_together')
        scale.anchor_0 = '0 Euros';
        scale.anchor_1 = '10 Euros';
        scale.anchor_2 = '20 Euros';
        scale.anchor_3 = '30 Euros';
        scale.anchor_4 = '40 Euros';
        scale.anchor_5 = '50 Euros';
        scale.anchor_6 = '60 Euros';
        scale.anchor_7 = '70 Euros';
        scale.anchor_8 = '80 Euros';
        scale.anchor_9 = '90 Euros';
        scale.anchor_10 = '100 Euros';
...
%%Questions
if  strcmp(trial.type,'wanted')
    if settings.lang_de == 1
        if subj.shake == 4
            text_question = ['Wie sehr wollen Sie das Wasser erhalten?'];
        else
        ...
        if subj.shake == 4
            ...
            text_question = ['How much did you want to receive the water?']; %
        end
    end
elseif  strcmp(trial.type, 'liking')
    if settings.lang_de == 1
        if subj.shake == 4
            text_question = ['Bitte bewerten Sie das Wasser im Vergleich zu allen bisher in Ihrem Leben erfahrenen Empfindungen.'];
        else
        ...
        if subj.shake == 4
            text_question = ['Please rate the water in comparison with all of the sensations you have experienced in your life.']; %english translation
        else
...
elseif strcmp(trial.type,'fcqtr_1') ||strcmp(trial.type,'fcqtr_2')
    text_question =[trial.question];
elseif strcmp(trial.type,'load_shake')
    if settings.lang_de == 1
        if subj.shake == 4
            text_question = ['Wie ' trial.question ' fanden Sie das Wasser?'];
        else
            text_question = ['Wie ' trial.question ' fanden Sie den Shake?'];
        end
    else
        if subj.shake == 4
            text_question = ['How ' trial.question ' did you find the water?'];
        else
            text_question = ['How ' trial.question ' did you find the milkshake?'];
        end%english translation -- not sure how to translate this?
    end
elseif strcmp(trial.type,'load_muesli')
    if settings.lang_de == 1
...
elseif strcmp(trial.type,'willingnesspay')
    %text_question = trial.question;
elseif strcmp(trial.type,'activity_rating')
    if settings.lang_de == 1
        text_question = ['Bitte bewerten Sie wie gern Sie die folgende Freizeitaktivität im Vergleich zu allen Ihnen vorstellbaren Freizeitaktivitäten mögen:\n\n' trial.question ''];
        anchor.a1 = ['am allerstärksten gemochte \nAktivität, die vorstellbar ist'];
        anchor.a2 = ['extrem gern'];
        anchor.a3 = ['sehr gern'];
        anchor.a4 = ['gern'];
        anchor.a5 = ['ein bisschen gern'];
        ...
        anchor.a9 = ['sehr ungern'];
        anchor.a10 = ['extrem ungern'];
        anchor.a11 = ['am allerstärksten zuwidere \nAktivität, die vorstellbar ist'];
    else
        text_question = ['Please rate how much you like the following free time activity in comparison with all of the imaginable free time activities:\n' trial.question]; %english translation
        anchor.a1 = ['most liked activity imaginable'];
        anchor.a2 = ['like extremely'];
        anchor.a3 = ['like very much'];
        anchor.a4 = ['like moderately'];
        anchor.a5 = ['like slightly'];
        ...
        anchor.a9 = ['dislike very much' ];
        anchor.a10 = ['extremely dislike' ];
        anchor.a11 = ['most disliked activity imaginable'];

    end

elseif strcmp(trial.type,'activity_pay_alone')
    if settings.lang_de == 1
        text_question = ['Wie viel sind Sie bereit, für die folgende Freizeitaktivität auszugeben, wenn Sie diese alleine unternehmen:\n\n' trial.question];
    else
        text_question = ['How much are you willing to spend on the following free time activity if you were doing it alone:\n\n' trial.question];
    end

elseif strcmp(trial.type,'activity_pay_together')
    if settings.lang_de == 1
        text_question = ['Wie viel sind Sie bereit, für die folgende Freizeitaktivität auszugeben, wenn Sie diese mit jemand anderem zusammen unternehmen:\n\n' trial.question];
    else
        text_question = ['How much are you willing to spend on the following free time activity if you were doing it together with someone else:\n\n' trial.question];
    end
...
if strcmp(trial.type, 'liking') % vertical scale
        ...
        while (GetSecs - startTime) < max_dur_rating && flag_resp == 0 %mousebuttons(1)~=1
            ...
            if (GetSecs > nextTime) %Sample every 0.01 seconds
                ...
                if flag_resp==1 %Terminate and record rating on left mouseclick
                    ...
                    rating = 100-((Slider_y_pos - Scale_offset)/Scale_height)*200; %rescaling of scale_height independent of screen resolution [-100 to +100]
                    rating_subm = 1;
...
elseif strcmp(trial.type, 'activity_rating') % vertical scale
    ...
    DrawFormattedText(rating_scr, anchor.a1, (setup.ScrWidth/2+20), (Scale_offset + 5) + Scale_height * 0.000, color.scale_anchors,80, [],[],1.5);
    %DrawFormattedText(rating_scr, [text_freerating ' sensation'], (setup.ScrWidth/2+20), (Scale_offset - 10) + 20, [250 0 0],80);
    DrawFormattedText(rating_scr, anchor.a2, (setup.ScrWidth/2+20), (Scale_offset + 5) + Scale_height * 0.171, color.scale_anchors,80);
    DrawFormattedText(rating_scr, anchor.a3, (setup.ScrWidth/2+20), (Scale_offset + 5) + Scale_height * 0.278, color.scale_anchors,80);
    DrawFormattedText(rating_scr, anchor.a4, (setup.ScrWidth/2+20), (Scale_offset + 5) + Scale_height * 0.411, color.scale_anchors,80);
    DrawFormattedText(rating_scr, anchor.a5, (setup.ScrWidth/2+20), (Scale_offset + 5) + Scale_height * 0.469, color.scale_anchors,80);
    DrawFormattedText(rating_scr, anchor.a6, (setup.ScrWidth/2-160), (Scale_offset + 5) + Scale_height * 0.500, color.scale_anchors,80);
    DrawFormattedText(rating_scr, anchor.a7, (setup.ScrWidth/2+20), (Scale_offset + 5) + Scale_height * 0.530, color.scale_anchors,80);
    DrawFormattedText(rating_scr, anchor.a8, (setup.ScrWidth/2+20), (Scale_offset + 5) + Scale_height * 0.588, color.scale_anchors,80);
    DrawFormattedText(rating_scr, anchor.a9, (setup.ScrWidth/2+20), (Scale_offset + 5) + Scale_height * 0.708, color.scale_anchors,80);
    DrawFormattedText(rating_scr, anchor.a10, (setup.ScrWidth/2+20), (Scale_offset + 5) + Scale_height * 0.814, color.scale_anchors,80);
    DrawFormattedText(rating_scr, anchor.a11, (setup.ScrWidth/2+20), (Scale_offset + 5) + Scale_height * 1.000, color.scale_anchors,80, [],[],1.5);
    DrawFormattedText(rating_scr, text_question, (setup.ScrWidth/10), (Scale_offset + 5) + Scale_height * 0.2, [200 0 0],30,[],[],2);
    ...
    if do_gamepad == 1
        while (GetSecs - startTime) < max_dur_rating && flag_resp == 0 %mousebuttons(1)~=1
            ...
            if (GetSecs > nextTime) %Sample every 0.01 seconds
                ...
                if flag_resp==1 %Terminate and record rating on left mouseclick
                    t_rating_ref = t_button - startTime;
                    rating = 100-((Slider_y_pos - Scale_offset)/Scale_height)*100; %rescaling of scale_height independent of screen resolution [0-100]
                    rating_subm = 1;
    ...
    elseif strcmp(trial.type, 'activity_pay_alone') || strcmp(trial.type, 'activity_pay_together')
        ...
        DrawFormattedText(rating_scr, [scale.anchor_0], (setup.ScrWidth/2-Scale_width/2 + Scale_width*0.000), (Scale_offset+setup.ScrHeight/2 + 40), color.scale_anchors,80);

        DrawFormattedText(rating_scr, [scale.anchor_1], (setup.ScrWidth/2-Scale_width/2 + Scale_width*0.100), (Scale_offset+setup.ScrHeight/2 + 40), color.scale_anchors,80);

        DrawFormattedText(rating_scr, [scale.anchor_2], (setup.ScrWidth/2-Scale_width/2 + Scale_width*0.200), (Scale_offset+setup.ScrHeight/2 + 40), color.scale_anchors,80);

        DrawFormattedText(rating_scr, [scale.anchor_3], (setup.ScrWidth/2-Scale_width/2 + Scale_width*0.300), (Scale_offset+setup.ScrHeight/2 + 40), color.scale_anchors,80);

        DrawFormattedText(rating_scr, [scale.anchor_4], (setup.ScrWidth/2-Scale_width/2 + Scale_width*0.400), (Scale_offset+setup.ScrHeight/2 + 40), color.scale_anchors,80);

        DrawFormattedText(rating_scr, [scale.anchor_5], (setup.ScrWidth/2-Scale_width/2 + Scale_width*0.500), (Scale_offset+setup.ScrHeight/2 + 40), [205 201 201],80);

        DrawFormattedText(rating_scr, [scale.anchor_6], (setup.ScrWidth/2-Scale_width/2 + Scale_width*0.600), (Scale_offset+setup.ScrHeight/2 + 40), color.scale_anchors,80);

        DrawFormattedText(rating_scr, [scale.anchor_7], (setup.ScrWidth/2-Scale_width/2 + Scale_width*0.700), (Scale_offset+setup.ScrHeight/2 + 40), color.scale_anchors,80);

        DrawFormattedText(rating_scr, [scale.anchor_8], (setup.ScrWidth/2-Scale_width/2 + Scale_width*0.800), (Scale_offset+setup.ScrHeight/2 + 40), color.scale_anchors,80);

        DrawFormattedText(rating_scr, [scale.anchor_9], (setup.ScrWidth/2-Scale_width/2 + Scale_width*0.900), (Scale_offset+setup.ScrHeight/2 + 40), color.scale_anchors,80);

        DrawFormattedText(rating_scr, [scale.anchor_10], (setup.ScrWidth/2-Scale_width/2 + Scale_width*1.000), (Scale_offset+setup.ScrHeight/2 + 40), color.scale_anchors,80);
    ...
    %show current rating on screen for social willingness to pay
    if strcmp(trial.type, 'activity_pay_alone') || strcmp(trial.type, 'activity_pay_together')
        if settings.lang_de == 1
            DrawFormattedText(w, '50,00 Euro', 'center', (Scale_offset+setup.ScrHeight/2 + 300), [250 0 0]);
        else
            DrawFormattedText(w, '50.00 Euros', 'center', (Scale_offset+setup.ScrHeight/2 + 300), [250 0 0]);
        end
    end
        ...
        while (GetSecs - t_scale_trigger) < max_dur_rating && flag_resp == 0 %mousebuttons(1)~=1
            ...
            if (GetSecs > nextTime) %Sample every 0.01 seconds
                ...
                elseif (proj_x ~= Slider_x_pos) %Update screen if participant has scrolled up or down
                    ...
                    %show current rating  on screen for social willingness to pay
                    if strcmp(trial.type, 'activity_pay_alone') || strcmp(trial.type, 'activity_pay_together')
                        current_rating = round(((Slider_x_pos - (setup.ScrWidth/2-Scale_width/2))/ Scale_width)*100, 1); %rescaling of scale_width independent of screen resolution [0-100]
                        if settings.lang_de == 1
                            if current_rating == floor(current_rating)
                                current_rating_txt = [num2str(current_rating), ',00 Euro'];
                            else
                                current_rating_txt = [num2str(current_rating), '0 Euro'];
                            end
                            current_rating_txt(current_rating_txt=='.') = ',';
                        else
                            if current_rating == floor(current_rating)
                                current_rating_txt = [num2str(current_rating), '.00 Euros'];
                            else
                                current_rating_txt = [num2str(current_rating), '0 Euros'];
                            end                        
                        end
                        DrawFormattedText(w, current_rating_txt, 'center', (Scale_offset+setup.ScrHeight/2 + 300), [250 0 0]);
                    end
