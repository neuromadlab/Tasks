...
function global_experiment_settingsRoutineBegin(snapshot) {
  return async function () {
    ...
    global_experiment_settingsComponents.forEach( function(thisComponent) {
...
function jitter_settingsRoutineBegin(snapshot) {
  return async function () {
    ...
    jitter_settingsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function mobile_instructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    mobile_instructionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_settingsRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_settingsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function stimulus_ratingRoutineBegin(snapshot) {
  return async function () {
    ...
    stimulus_ratingComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
