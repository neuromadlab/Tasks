...
if  strcmp(trial.type,'Caloric_wanting')
    text_question = ['Wie sehr wollen Sie das Getraenk jetzt gerade erhalten?'];
    scale.a1 = ['Ueberhaupt nicht'];
    scale.a7 = ['Sehr stark'];
...
elseif  strcmp(trial.type,'Caloric_liking')
    text_question = ['Bitte bewerten Sie das Getraenk jetzt gerade im Vergleich zu allen bisher in Ihrem Leben erfahrenen Empfindungen.'];
