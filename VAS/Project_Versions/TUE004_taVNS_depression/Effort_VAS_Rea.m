...
t_scale_trigger = GetSecs; 
    ...
    if strcmp(trial.question,'pain')
       ...
       scale.anchor_ModerateTingling = 'Moderate\nTingling';
       scale.anchor_StrongTingling = 'Strong\nTingling';
       scale.anchor_LightPricking = 'Light\nPricking';
       scale.anchor_ModeratePricking = 'Moderate\nPricking';    
       scale.anchor_Pricking = 'Pricking';
       scale.anchor_Pain = 'Pain';
 ...
 %%Questions   
    ...
    elseif strcmp(trial.question,'pain')
        text_question =['How intense was the pain caused by te stimulation?']
