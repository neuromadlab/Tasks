...
% This Version: Projectversion for TUE012, April 2024, Kristin Kaduk
...
if  strcmp(trial.type,'Influenca_1')
    text_question = ['Wie zufrieden sind Sie gerade mit sich selbst?'];
    scale.anchor_1 = ['Gar nicht'];
    scale.anchor_7 = ['Sehr'];
    
    
elseif  strcmp(trial.type,'Influenca_2')
    text_question = ['Wie ist Ihr psyschiches Befinden im Moment?'];
    scale.anchor_1 = ['Sehr schlecht'];
    scale.anchor_7 = ['Sehr gut'];
    
elseif  strcmp(trial.type,'Influenca_3')
    text_question = ['Wie ist Ihr körperliches Befinden im Moment?'];
    scale.anchor_1 = ['Sehr schlecht'];
    scale.anchor_7 = ['Sehr gut'];
...
DrawFormattedText(rating_scr, text_question, 'center', (Scale_offset+setup.ScrHeight/2 - 150), color.scale_anchors,40,[],[],2);
    ...
    if strcmp(trial.type,'Caloric_load')
        DrawFormattedText(rating_scr, [scale.b1], (setup.ScrWidth/2-Scale_width/2 - 65), (Scale_offset+setup.ScrHeight/2 + 40), color.scale_anchors,80);
        ...
        DrawFormattedText(rating_scr, [scale.b7], (setup.ScrWidth/2+Scale_width/2 - 35), (Scale_offset+setup.ScrHeight/2 + 40), color.scale_anchors,80);
