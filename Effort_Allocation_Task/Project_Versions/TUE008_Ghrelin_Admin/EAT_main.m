...
% last updated for TUE008 in July 2024 by Buket Solak
%
...
load('./EATsettings_TUE008_S1_R1.mat') % same settings for PHEN and ADMIN
...
subj.sessionID = input('Session ID [1 (phen) 2 (admin day1) 3 (admin day 2)]: ','s'); 
...
elseif settings.do_gamepad == 1
    if subj.sessionID == '3' % if S3 then take max effort from S2 training
        maxeffort_searchname = [[pwd filesep 'data' filesep 'TrainEAT_' ...
                            subj.study '_'  subj.subjectID '_S2'] '*'];
    else
        maxeffort_searchname = [[pwd filesep 'data' filesep 'TrainEAT_' ...
                            subj.study '_'  subj.subjectID '_S' subj.sessionID] '*'];
    end
