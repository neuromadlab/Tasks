...
instr_en.text_Cont       = 'Continue with mouse click.';
...
instr_en.first_round_train  = ['Please do not change how you hold the controller during the game.' ...
...
instr_en.strt_actual_train  = ['You will now practice the actual task:' ...
    ...
    ' try to move the ball up and over a red line by repeatedly pressing the button.' ...
...
instr_en.intro_tvns         = ['The difference from the practice session from earlier is that we will also be stimulating the vagus nerve at your ear.' ...
    ' The stimulation will start simultaneously with each trial.'];
...
instr_en.time_exp           = ['The whole experiment will take about 40 minutes.\nIf you have any questions,'...
    ' you can ask them right now.\nWhen you feel ready, we can begin the experiment.'];
