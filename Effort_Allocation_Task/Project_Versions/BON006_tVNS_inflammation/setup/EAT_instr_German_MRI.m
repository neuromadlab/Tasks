...
instr.train_welcome_text = ['Willkommen.' ...
                            ...
                            ' Das eigentliche Spiel werden Sie zu einem spaeteren Studientermin spielen.'];
                  
% instr.train_instr        = ['Auf dem Bildschirm werden Sie gleich ein nach oben geoeffnetes Gefaess mit einem blauen Ball darin sehen.' ...
...
instr.middle_round_train = 'Halten Sie das Geraet in den folgenden 10 Sekunden einfach nur locker in den Haenden ohne zuzudruecken.';
...
instr.train_instr_left   = ['Auf dem Bildschirm werden Sie gleich ein nach oben geoeffnetes Gefaess mit einem blauen Ball darin sehen. ' ...
                            ' Wenn Sie den Griff in Ihrer Hand zusammendruecken, bewegt sich der Ball nach oben. ' ...
                            ' Je fester Sie druecken, desto hoeher steigt der Ball.' ...
                            ' \nIn den naechsten Durchgaengen sollen Sie sich mit dem Geraet vertraut machen.' ...
                            ' Bitte bewegen Sie sich waehrend der Messung nicht und veraendern Sie Ihre Handhaltung nicht im Verlauf des Spiels.' ...
                            ' \n\nAls erstes versuchen Sie bitte in den naechsten 10 Sekunden den Ball so hoch steigen zu lassen,' ...
                            ' wie Sie koennen, indem Sie den Griff in Ihrer LINKEN Hand drücken.'];

instr.second_round_train_left = ['Versuchen Sie in den folgenden 10 Sekunden noch einmal den Ball so hoch wie moeglich steigen zu lassen.' ...
                            ' \nBenutzen Sie hierfür noch einmal den Griff in Ihrer LINKEN Hand.'];

instr.first_round_train_right = ['Benutzen Sie für die nächsten zwei Durchgänge nun den Griff in Ihrer RECHTEN Hand.' ...
                            ' Bitte veraendern Sie waehrend des Versuchs Ihre Handhaltung nicht.' ...
                            ' \nVersuchen Sie in den folgenden 10 Sekunden noch einmal den Ball so hoch wie moeglich steigen zu lassen,' ...
                            ' indem Sie den Griff in Ihrer RECHTEN Hand drücken.'];

instr.second_round_train_right = ['Versuchen Sie in den folgenden 10 Sekunden noch einmal den Ball so hoch wie moeglich steigen zu lassen.' ...
                            ' \nBenutzen Sie hierfür noch einmal den Griff in Ihrer RECHTEN Hand.'];

% bidding section
           
% instr.bidding            = ['Die folgenden Durchgaenge dienen dazu, die Aufgabe fuer Sie individuell anzupassen.' ...
...
instr.strt_actual_train  = ['Jetzt ueben Sie die eigentliche Aufgabe:' ...
                            ...
                            ' \n\nDie nun folgende Uebungsphase wird ca. 5 Minuten dauern. Bitte benutzen Sie das Geraet in Ihrer RECHTEN Hand.'];
...
%                             ' \n\nVersuchen Sie mithilfe von Druck den Ball nach oben und ueber die rote Linie zu bewegen.' ...
%                             ' Sie koennen Punkte gewinnen fuer jede volle Sekunde, die der Ball ueber der roten Linie bleibt.'];

% instr.intro_exp2         = ['Der Unterschied zur Uebung vorhin ist, dass wir gleichzeitig zur Aufgabe die Vagusnerv-Stimulation am Ohr durchfuehren.' ...
...
%                             ' um danach wieder staerkeren druecken zu koennen.'];
%                         
...
% instr.time_exp           = ['Das gesamte Experiment wird ca. 20 Minuten dauern.\nSollten Sie noch Fragen haben,'...
%                             ' koennen Sie diese jetzt stellen.\nWenn Sie sich bereit fuehlen, koennen wir jetzt mit dem Experiment beginnen.']; 
