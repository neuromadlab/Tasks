...
output.PANAS.rating_happy_runstart(1,i_trial)  = startTime; %Start time of rating
output.PANAS.rating_happy(1,i_trial)           = rating;
output.PANAS.rating_happy_label{1,i_trial}     = rating_label;
output.PANAS.rating_happy_subm(1,i_trial)      = rating_subm;
output.PANAS.rating_happy_t_button(i_trial,5)  = t_rating_ref; %Time of rating submission
...
output.PANAS.rating_unhappy_runstart(1,i_trial)  = startTime; %Start time of rating
output.PANAS.rating_unhappy(1,i_trial)           = rating;
output.PANAS.rating_unhappy_label{1,i_trial}     = rating_label;
output.PANAS.rating_unhappy_subm(1,i_trial)      = rating_subm;
output.PANAS.rating_unhappy_t_button(i_trial,5)  = t_rating_ref; %Time of rating submission
