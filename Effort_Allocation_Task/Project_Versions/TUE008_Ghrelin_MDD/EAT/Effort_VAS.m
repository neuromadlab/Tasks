...
if strcmp(trial.question,'pain')
    if settings.lang_de == 1
       ...
       scale.anchor_StrongTingling      = 'clearly\nsnoticeable\nprickling';
       ...
       scale.anchor_StrongestSensation  = 'strongest imaginable sesnsation';
    end
   scale.anchor_0  = '0';
   scale.anchor_1  = '1';
   scale.anchor_2  = '2';
...
if  strcmp(trial.question,'wanted')
    if settings.lang_de == 1
        ...
        text_question = ['How much did you want the reward shown in this trial?'];
    end
...
%     else
%       text_question = ['How strong was the feeling of pain from the stimulation?']
%     end
else %e.g. strcmp(trial.question,'hungry')
    if settings.lang_de == 1
        text_question = ['Wie ' trial.question  ' fuehlen Sie sich im Moment?'];
    else
        text_question = ['How ' trial.question  ' do you feel in this moment?'];
    end
end
