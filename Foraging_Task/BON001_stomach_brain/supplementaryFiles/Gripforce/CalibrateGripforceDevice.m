...
GripFSpec.MinL		= 32760; % minimum value of the left gripforce device
GripFSpec.MaxL		= 500;
GripFSpec.MinR      = 32760; % minimum value of the right gripforce device
GripFSpec.MaxR      = 500;
targetRange         = [0 100];
...
FlagSave = input('Would you like to save the settings? [y/n]: ', 's');
