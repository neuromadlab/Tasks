...
load('C:\Users\Forschung - Admin\SynologyDrive\Tasks\FCR\Project_Versions\FCR_Images\TUE008_updated\Documentation\TUE008_FCR_Food_Stimuli.mat');
load('C:\Users\Forschung - Admin\SynologyDrive\Tasks\FCR\Project_Versions\FCR_Images\TUE008_updated\Documentation\TUE008_FCR_NonFood_Stimuli.mat');
...
for n = 1:study.participants
    ...
    save([pwd,filesep, 'Order_',study.name,filesep,'FCRcond_mat_',study.name,'_',subj_ind,'_S', num2str(study.sessions), '.mat'],'design')
