...
% last updated in July 2024 by Buket Solak
% with: Matlab R2014a using Psychtoolbox 3.0.11

% currently Matlab R2021b, Psychtoolbox 3.0.16
% Current Version: 3 (last adapted for TUE008, July 2024, Buket Solak) 
% =========================================================================
clear
sca
...
subj.study = 'TUE008'; % Enter here current study name
...
if settings.do_fmri == 1 
    ...
    part_file = ['Order_' subj.study filesep 'FCRcond_mat_' subj.study '_' subj.subjectID '_S' subj.sessionID '.mat'];
end
