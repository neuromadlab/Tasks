...
stimuli_indices = fullfile(pwd,filesep,'Documentation',filesep,'FCR_Stimuli_reduced_Set.mat');
load(stimuli_indices)

% concatenate Food and NonFood Stimuli 
stimuli_all = [FCR_Food_Stimuli.ImageNr; FCR_NonFood_Stimuli.ImageNr]; 
