...
subj.subjectID = input('Subject ID [1-60]: ','s');
subj.subjectID = ['1',pad(subj.subjectID,5,"left",'0')];
...
elseif strcmp(start_part,'n')
    if subj.runID == '2'
        first_block = input('Which block do you want to start? [1-5] ','s');
    else
        first_block = input('Which block do you want to start? [1-4] ','s');
    end
