...
for i_sub = 81:n_id
    ...
    combinations(:,end+1) = [ones(4,1);ones(5,1)*2];
    ...
    if pilot == 0
        name_file = strcat('settings/taVNSoptimize_', setup.study, '_1' , pad(num2str(i_sub),5,"left",'0'), '_S', num2str(i_sess),'.mat');
    else
...
if pilot == 0
    save([home_dir,'SynologyDrive/Projects/',study_name.name,'/06_Participants/Stimulation_conditions_optimization.mat'],"conditions")
end
end