...
%     end
    ...
    if doTVNS
        ...
        stimFreq = 25;  % input('Stimulation frequency: ', 's');
        stimDur = 5; %jitter(count_jitter);
...
%         Effort_VAS
        ...
        rating = input('Pain rating of: ');
        disp(['Pain rating of ',num2str(rating),'. Should be about 50.'])
        output.rating(i_level,1) = rating; %rating value
        output.stimAmpl(i_level,1) = str2double(stimAmpl);
...
% This function initializes the tVNS device
    ...
    bSettings =  matlab.net.http.MessageBody(...
        ['minIntensity=',num2str(stimAmpl),...
        '&maxIntensity=',num2str(stimAmpl), ...
        '&impulseDuration=250&frequency=',num2str(stimFreq),...
        '&stimulationDuration=',num2str(stimDur),...
        '&pauseDuration=32']); % pause needs to be longer than trial
